...
public class Main {
    ...
    public static void task1() {
        ...
        int age = 25;
        if (age >= 21) {
            System.out.println(" Если возраст человека равен 18, то он достиг совершеннолетия");
        }
        int age1 = 3;
        if (age1 < 21) {
            System.out.println(" Если возраст человека не равен 18, то он не достиг совершеннолетия, нужно немного подождать");
        }
    }
    ...
    public static void task2() {
        ...
        int temperature = -7;
        if (temperature < 5) {
            System.out.println(" На улице -7 холодно, нужно надеть шапку");
        }
        int temperature1 = 5;
        if (temperature1 >= 5) {
            System.out.println(" Сегодня +5 тепло, можно идти без шапки");
        }
    }
    ...
    public static void task3() {
        ...
        int speed = 58;
        if (speed > 60) {
            System.out.println(" Если скорость больше 60, то придется платить штраф ");
        } else {
